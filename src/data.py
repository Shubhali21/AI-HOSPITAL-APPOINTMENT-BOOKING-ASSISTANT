...
from utils.jsontocsv import save_to_csv
...
print("Receptionist: Hello! How may I assist you today?")
...
save_to_csv(data, filename="appointments.csv")

# Run the chain
#response = chain.invoke({"question": "I want to book an appointment with a cardiologist for tomorrow morning."})
